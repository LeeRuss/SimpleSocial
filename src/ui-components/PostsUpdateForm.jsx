...
export default function PostsUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = postsRecord
      ...
      : initialValues;
    setCreation_time(cleanValues.creation_time);
  ...
  return (
    ...
    >
      <TextField
        ...
        isReadOnly={false}
        type="datetime-local"
        value={creation_time && convertToLocal(new Date(creation_time))}
        onChange={(e) => {
          let value =
          ...
          if (errors.creation_time?.hasError) {
            runValidationTasks("creation_time", value);
          }
          setCreation_time(value);
        }}
        onBlur={() => runValidationTasks("creation_time", creation_time)}
        errorMessage={errors.creation_time?.errorMessage}
        hasError={errors.creation_time?.hasError}
        {...getOverrideProps(overrides, "creation_time")}
      ></TextField>
      <TextField
        label="Text"
        isRequired={true}
